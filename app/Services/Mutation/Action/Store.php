...
final class Store extends Service
{
    ...
    const RULES_VALIDATOR = [
        ...
        'commition' => 'required|integer|lte:amount',
    ];
    ...
    function call(): ServiceResponse
    {
        ...
        try {
            ...
            if ($balance < $this->request->amount) {
                DB::rollBack();
                return parent::error("jumlah penarikan tidak boleh melebihi saldo investor");
            }

            MutationRepository::create([
                'seller_id' => $this->seller_id,
                'amount'    => - ($this->request->amount - $this->request->commition),
