            ...
            <td class="container">
                <div class="content">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                        ...
                        <tr>
                            <td class="wrapper">
                                <h3>Hi, {{ $transaction->buyer->name }}!</h3>
                                <p>
                                    Selamat proses booking villa berhasil
                                    <br>
                                    Berikut adalah data booking yang digunakan pada proses check-in
                                </p>
                                <table role="presentation" border="1" cellpadding="0" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Nama</td>
                                            <td>{{ $transaction->transactionDetail->name }}</td>
                                        </tr>
                                        <tr>
                                            <td>Villa</td>
                                        ...
                                        <tr>
                                            <td>Tanggal</td>
                                            <td>{{ $transaction->transactionDetail->full_date }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
