            ...
            <tbody class="table-border-bottom-0">
                @forelse ($banks as $bank)
                    <tr>
                        ...
                        <td data-key="status" data-value="{{ $bank->is_active }}">{{ ucwords($bank->is_active_label) }}</td>
                        <td class="text-end" data-key="id" data-value="{{ $bank->id }}"><button class="btn btn-primary btn-sm editButton"">Edit</button></td>
                    </tr>
                @empty
                    <tr>
